    ...
    public static class PositionExtensions
    {
        public static CorePosition ToCore(this EFPosition item)
        {
            ...
            return new CorePosition()
            {
                ...
                Altitude1 = item.Altitude1.HasValue ? item.Altitude1.Value : new Nullable<int>(),
                Speed1 = item.Speed1.HasValue ? item.Speed1.Value : new Nullable<int>(),
                Heading1 = item.Heading1.HasValue ? item.Heading1.Value : new Nullable<int>(),
                ...
                Altitude2 = item.Altitude2.HasValue ? item.Altitude2.Value : new Nullable<int>(),
                Speed2 = item.Speed2.HasValue ? item.Speed2.Value : new Nullable<int>(),
                Heading2 = item.Heading2.HasValue ? item.Heading2.Value : new Nullable<int>(),
                ...
                Altitude3 = item.Altitude3.HasValue ? item.Altitude3.Value : new Nullable<int>(),
                Speed3 = item.Speed3.HasValue ? item.Speed3.Value : new Nullable<int>(),
                Heading3 = item.Heading3.HasValue ? item.Heading3.Value : new Nullable<int>(),
